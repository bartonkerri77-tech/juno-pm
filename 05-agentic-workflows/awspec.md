...
| 3 | Route wireframe to the project PM review based on confidence threshold. | _ |  |
| 4 | Make a copy of Executive Stakeholder template | _ |  |
...
| 9 | Notify the PM via Slack that the deck is ready to be shared | _ |  |
